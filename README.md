...
- 💻 **Internship experience** in building cloud-native **agentic AI** workflows with Google ADK and **predictive analytics** solutions with Amazon SageMaker
...
2. **Knowledge Distillation for Medical Imaging:** improved AI Dermatologist with teacher–student distillation using Google MedSigLIP, and a MobileNetV3-Large student model
3. **Traffic Light Autoencoder for Autonomous Vehicles:** convolutional autoencoder to compress & reconstruct 256×256 traffic light images from 14K+ scenarios
